...
const options: { value: VoteValue; label: string; icon: React.ReactNode; active: string; hover: string }[] = [
  {
    value: 'approve',
    label: 'Approve',
...
export function VoteButton({ initiativeId, currentVote, onVote }: VoteButtonProps) {
